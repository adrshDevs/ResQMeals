[![Live Demo](https://img.shields.io/badge/Live_Demo-Click_Here-success?style=for-the-badge)](https://adrshDevs.github.io/ResQMeals/index.html)
...
**Landing page** — mission statement, live impact stats, and local weather-based demand signal.

![Landing page](assets/landing.png)

**Role selection** — choose Donor, Volunteer, NGO, or Admin, or raise an emergency food request.

![Role selection modal](assets/role-select.png)

**Command Center dashboard** — live meals-today count, active posts, volunteers, NGO partners, and an AI shortage alert.

![Command Center dashboard](assets/dashboard.png)

**Live tracking** — real-time volunteer location, delivery progress, and route simulation.

![Live tracking map](assets/live-tracking.png)

**Demand heatmap** — city-wide donation demand by neighborhood, plus recent activity feed.

![Demand heatmap](assets/demand-heatmap.png)
